...
interface IMasonry {
    ...
    function getStombPrice() external view returns (uint256);
...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        // address(0x683b16B985f37B0f1B227c2C0264d3f8d05Eee37), // Genesis
        address(0x000000000000000000000000000000000000dEaD) // Burned tokens
    ];
    ...
    function initialize(
        ...
        maxExpansionTiers = [400, 350, 300, 250, 200, 175, 150, 125, 100];
