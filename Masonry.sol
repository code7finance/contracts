...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 2; // Lock for 2 epochs (12h) before release withdraw
        rewardLockupEpochs = 1; // Lock for 1 epochs (6h) before release claimReward TOMB ON STEROIDS
